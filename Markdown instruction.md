...
Выполнил техническое задание по github

Забыл создать отдельную ветку для внесения изменений, сделал доработку

Внести изменения в репрозиторий файла и отправить внесенные изменения на проверку.

Задание выполнено и готово для отправки
